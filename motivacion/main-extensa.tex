...
\es{En él, cooperar implica un coste $c$ para que la otra persona reciba un beneficio de valor $v$, con $v > c$, y desertar significa negarse a cooperar y no conlleva ningún costo.}%
%
...
%
\en{However, what actually happens under multiplicative selection processes, the defecting variants negatively affect their own long-term growth rate because this behavior, by increasing the fluctuations on whom it depends (the cooperators), also increases their own fluctuations.}%
\es{Sin embargo, lo que se observa bajo procesos de selección multiplicativa es que las variantes desertoras afectan negativamente su propia tasa de crecimiento a largo plazo debido a que este comportamiento, al aumentar las fluctuaciones que en quienes depende (los cooperadores), aumenta también sus propias fluctuaciones.}
...
En las últimas décadas la biología evolutiva ha comenzado a adoptar la analogía de la ``tragedia de los comunes''~\cite{rankin2007-tragedyCommonsBiology}.
%
...
%
En un dilema del prisionero de dos jugadores, cooperar implica un coste $c$ para que la otra persona reciba un beneficio b, con $b > c$, y desertar significa negarse a cooperar y no conlleva ningún coste.
