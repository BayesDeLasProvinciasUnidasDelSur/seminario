...
\en{The multiplicative structure of hypothesis selection processes, by sequence of surprises, has concrete consequences for knowledge.}%
\es{La estructura multiplicativa de los procesos de selección de hipótesis, por secuencia de sorpresas, tiene consecuencias concretas para el conocimiento.}%
%
...
%
\en{In empirical knowledge, hypotheses cooperate to form variables, variables cooperate to form causal models, and sets of models cooperate to form theories (or cultures).}%
\es{En el conocimiento empírico, las hipótesis cooperan para formar variables, las variables cooperan para formar modelos causales, y los conjuntos de modelos cooperan para formar teorías (o culturas).}%
...
\centering
 ...
 \end{subfigure}
 \caption{
 \en{The emergence of higher level units in life.}%
 \es{La emergencia de unidades de nivel superior en la vida.}%
 }
 \label{fig:trans}
 \vspace{-0.3cm}
 \end{figure}
...
\en{The emergence of higher level units is a permanent phenomenon in the history of life and knowledge.}%
\es{La emergencia de unidades de nivel superior es un fenómeno permanente en la historia de la vida y del conocimiento.}%
%
