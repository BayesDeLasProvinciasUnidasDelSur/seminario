...
\en{The emergence of higher level units is a permanent phenomenon in the history of life.}%
\es{La emergencia de unidades de nivel superior es un fenómeno permanente en la historia de la vida.}%
%
...
%
\en{If evolution were subject to a prisoner's dilemma, then defecting in entirely cooperative groups should offer a higher growth rate than cooperating.}%
\es{Si la evolución estuviera sujeta a un dilema del prisionero, entonces desertar en grupos enteramente cooperativos debería ofrecer una tasa de crecimiento más alta que cooperar.}%
%
...
%
\en{Under multiplicative selection processes, however, it is not possible to take advantage of defection because, by increasing the fluctuations on which it depends (cooperators), it also increases its own fluctuations, negatively affecting its own long-term growth rate.}%
\es{Bajo procesos de selección multiplicativa, sin embargo, no se puede sacar provecho mediante la deserción porque, al aumentar las fluctuaciones que en quienes depende (cooperadores), aumenta también sus propias fluctuaciones afectando negativamente su propia tasa de crecimiento de largo plazo.}%
%
\begin{figure}[ht!]
\centering
\hspace{-1cm}
...
\en{For our species, the evolution of mutual understanding produced a radical change.}%
\es{Para nuestra especie, la evolución de la comprensión mutua produjo un cambio radical.}%
%
...
%
\en{Organized in small nomadic societies, we walked from Africa to South America.}%
\es{Organizados en pequeñas sociedades nómadas, caminando salimos de África y llegamos hasta sud América.}%



\begin{figure}[ht!]
\centering
 \begin{subfigure}[b]{0.12\textwidth} \centering
