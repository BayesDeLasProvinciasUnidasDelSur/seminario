...
\institute[DC-ICC-CONICET]{\vspace{1.25cm} \includegraphics[width=0.2\textwidth]{../../images/logofcen}}
\date{}
...
%  \includegraphics[width=0.27\textwidth]{../../images/logoAntropocaos} 
%  \end{textblock}
%   \begin{textblock}{100}(57,13.5)
%  \includegraphics[width=0.57\textwidth]{../../images/argonautasDelCaos} 
%  \end{textblock}
% 
 \vspace{2cm}
\maketitle
...
\begin{figure}[H]     
     ...
     \begin{subfigure}[b]{0.75\textwidth}
       \includegraphics[width=1\textwidth]{../../images/incertidumbre.jpeg} 
     \end{subfigure}
\end{figure}
...
\only<8>{
 \begin{textblock}{128}(0,30)\centering
 \includegraphics[width=0.55\textwidth]{../../figures/montyHall_6}     
 \end{textblock}
}
\only<9>{
 \begin{textblock}{128}(0,30)\centering
...
\only<10>{
 \begin{textblock}{128}(0,30)\centering
 \includegraphics[width=0.55\textwidth]{../../figures/montyHall_8}     
 \end{textblock}
}
\only<11>{
 \begin{textblock}{128}(0,30)\centering
...
\pause
 ...
 \centering
Permite actualizar nuestras creencias de forma

óptimas dadas restricciones: modelos y datos
 \end{mdframed}
}
...
\begin{center}
 ...
 \normalsize Como fuente de información
\end{center}
\end{textblock}
}
...
\begin{textblock}{118}(5,24)
  \begin{figure}[H]     
     ...
     \begin{subfigure}[b]{0.9\textwidth}
       \includegraphics[width=1\textwidth]{../../images/peligro_predador.jpeg} 
     \end{subfigure}
\end{figure}
\end{textblock}
...
\vspace{-1cm}
 ...
 \begin{center}
\includegraphics[width=0.23\textwidth]{../../images/dosdados.jpg}
 \end{center}
...
\begin{table}[H]
\begin{tabular}{lllll}
                      &  \includegraphics[page=17,width=0.065\textwidth]{../../figures/forkingPath}                 &    $y_j$            &       \includegraphics[page=19,width=0.065\textwidth]{../../figures/forkingPath}                  &  \\[0.1cm] \cline{2-4}
\multicolumn{1}{l|}{\includegraphics[page=2,width=0.065\textwidth]{../../figures/forkingPath}} & \multicolumn{1}{l|}{\textcolor{white}{$n_{ij}$}} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &  \\[0.1cm] \cline{2-4}
\multicolumn{1}{l|}{$x_i$} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{$n_{ij}$} & \multicolumn{1}{l|}{} &  $f_i$ \\[0.1cm] \cline{2-4}
\multicolumn{1}{l|}{\includegraphics[page=6,width=0.065\textwidth]{../../figures/forkingPath}} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{\textcolor{white}{$n_{ij}$}} &  \\[0.1cm] \cline{2-4}
&  & ${c_j}$ & & $N$
\end{tabular}
\end{table}
...
% \centering
%  Datos: \includegraphics[page=1,width=0.065\textwidth]{../../figures/forkingPath} \hspace{0.3cm}
%  Creencias: \includegraphics[page=2,width=0.075\textwidth]{../../figures/forkingPath}, \includegraphics[page=3,width=0.075\textwidth]{../../figures/forkingPath}, \includegraphics[page=4,width=0.075\textwidth]{../../figures/forkingPath}, \includegraphics[page=5,width=0.075\textwidth]{../../figures/forkingPath}, \includegraphics[page=6,width=0.075\textwidth]{../../figures/forkingPath} 
% 
%  \vspace{0.2cm}
% 
...
%  
% 
% \includegraphics[page=12,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath}
% 
% \end{textblock}
% }
% 
...
%  
% 
% \includegraphics[page=13,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath}
% 
% \end{textblock}
...
%  
% 
% \includegraphics[page=14,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath}
% 
% \end{textblock}
...
%  
% 
% \includegraphics[page=15,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath}
% 
% \end{textblock}
...
%  
% 
% \includegraphics[page=16,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath}
% 
% \end{textblock}
...
%  
% 
% \includegraphics[page=7,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath}
% \end{textblock}
% }
...
%  
% 
% \includegraphics[page=8,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=3,width=0.05\textwidth]{../../figures/forkingPath}
% \end{textblock}
% }
% 
% \only<11>{
...
%  
% 
% \includegraphics[page=9,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=4,width=0.05\textwidth]{../../figures/forkingPath}
% \end{textblock}
% }
% 
% \only<12>{
...
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=5,width=0.05\textwidth]{../../figures/forkingPath}
% \end{textblock}
% }
% 
% \only<13->{
...
%  
% 
% \includegraphics[page=11,width=0.6\textwidth]{../../figures/forkingPath}
% 
% \scriptsize Caminos dado $M$ y $C=$ \includegraphics[page=6,width=0.05\textwidth]{../../figures/forkingPath}
% \end{textblock}
% }
% 
% 
...
% \\ \cline{1-2} \\[-0.2cm]
% 
% \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath} &   & \textcolor{white}{$\frac{0 \times 4 \times 0 }{4 \times 4 \times 4 } = \frac{0}{64} $} &  &  & \textcolor{white}{$\frac{0}{3+8+9} =  0.00 $}
%  \\[2pt]
%   & & & & &\\[2pt]
%   & & & & &\\[2pt]
%   & & & & &\\[2pt]
...
% \\ \cline{1-2} \\[-0.2cm]
% 
% \includegraphics[page=2,width=0.05\textwidth]{../../figures/forkingPath} & $0 \times 4 \times 0 = 0$  & \textcolor{white}{$\frac{0 \times 4 \times 0 }{4 \times 4 \times 4 } = \frac{0}{64} $} &  &  & \textcolor{white}{$\frac{0}{3+8+9} =  0.00 $}
%  \\[2pt]
%   & & & & &\\[2pt]
%   & & & & &\\[2pt]
%   & & & & &\\[2pt]
...
%   \includegraphics[page=3,width=0.05\textwidth]{../../figures/forkingPath} &  $1 \times 3 \times 1 = 3$ 
%  &$ 3/64 $ & $1/5$ & $\frac{3}{64}\frac{1}{5}$&\\[2pt]
%   \includegraphics[page=4,width=0.05\textwidth]{../../figures/forkingPath} &  $2 \times 2 \times 2 = 8$ &$8/64$&$1/5$ &$\frac{8}{64}\frac{1}{5}$ &\\[2pt]
%   & & & & &\\[2pt]
%   & & & & & \\[2pt]  \\[-0.2cm]
%  & & & & &
% \end{tabular}
...
%  &$ 3/64 $ & $1/5$ & $\frac{3}{64}\frac{1}{5}$&\\[2pt]
%   \includegraphics[page=4,width=0.05\textwidth]{../../figures/forkingPath} &  $2 \times 2 \times 2 = 8$ &$8/64$&$1/5$ &$\frac{8}{64}\frac{1}{5}$ &\\[2pt]
%   \includegraphics[page=5,width=0.05\textwidth]{../../figures/forkingPath} &  $3 \times 1 \times 3 = 9$ &$9/64$&$1/5$ &$\frac{9}{64}\frac{1}{5}$&\\[2pt]
%   & & & & & \\[2pt]  \\[-0.2cm]
%  & & & & &
% \end{tabular}
% \end{table}
...
%   \includegraphics[page=4,width=0.05\textwidth]{../../figures/forkingPath} &  $2 \times 2 \times 2 = 8$ &$8/64$&$1/5$ &$\frac{8}{64}\frac{1}{5}$ &\\[2pt]
%   \includegraphics[page=5,width=0.05\textwidth]{../../figures/forkingPath} &  $3 \times 1 \times 3 = 9$ &$9/64$&$1/5$ &$\frac{9}{64}\frac{1}{5}$&\\[2pt]
%   \includegraphics[page=6,width=0.05\textwidth]{../../figures/forkingPath} &  $4 \times 0 \times 4 = 0$ &$0/64$&$1/5$ &$\frac{0}{64}\frac{1}{5}$&\\[2pt]  \\[-0.2cm]
%  & & & & &
% \end{tabular}
% \end{table}
% \end{textblock}
...
%   \includegraphics[page=4,width=0.05\textwidth]{../../figures/forkingPath} &  $2 \times 2 \times 2 = 8$ &$8/64$&$1/5$ &$\frac{8}{64}\frac{1}{5}$ &\\[2pt]
%   \includegraphics[page=5,width=0.05\textwidth]{../../figures/forkingPath} &  $3 \times 1 \times 3 = 9$ &$9/64$&$1/5$ &$\frac{9}{64}\frac{1}{5}$&\\[2pt]
%   \includegraphics[page=6,width=0.05\textwidth]{../../figures/forkingPath} &  $4 \times 0 \times 4 = 0$ &$0/64$&$1/5$ &$\frac{0}{64}\frac{1}{5}$&\\[2pt]  \cline{5-5} \\[-0.2cm]
%  & & & & $P(D|M)$ &
% \end{tabular}
% \end{table}
% \end{textblock}
...
%   \includegraphics[width=1\textwidth]{../../images/laberintoPorArriba.jpg}
%  \end{textblock}
%  
%   
% \end{frame}
...
\begin{frame}
 ...
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_0.pdf}
 \end{textblock}
 }
 ...
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_01.pdf}
 \end{textblock}
 }
 ...
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_02.pdf}
 \end{textblock}
 }
 ...
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_02bis.pdf}
 \end{textblock}
 }
 ...
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_03.pdf}
 \end{textblock}
 }
 ...
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_04.pdf}
 \end{textblock}
 }
 ...
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_05.pdf}
 \end{textblock}
 }
 \only<8>{
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_06.pdf}
 \end{textblock}
 }
 \only<9>{
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_07.pdf}
 \end{textblock}
 }
 \only<10>{
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_08.pdf}
 \end{textblock}
 }
 \only<11>{
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_09.pdf}
 \end{textblock}
 }
 \only<12-31>{
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_10.pdf}
 \end{textblock}
}
 \only<32->{
 \begin{textblock}{128}(0,22)
 \centering
  \includegraphics[width=1\textwidth]{../../figures/modelo_grafico_11.pdf}
 \end{textblock}
}
...
%        \includegraphics[width=1\textwidth]{../../images/messi_datos.jpeg} 
%      \end{subfigure}
% \end{figure}
% \end{textblock}
% 
...
% \includegraphics[width=1\textwidth]{../../figures/elo_for_trueskill}    
% \end{textblock}
% }
% 
% \only<3>{
% \begin{textblock}{128}(0,33)
% \includegraphics[width=1\textwidth]{../../figures/trueskill_from_elo}    
% \end{textblock}
% }
% 
% 
...
% \includegraphics[width=1\textwidth]{../../figures/elo-factor-es}    
% \end{textblock}
% 
% \end{frame}
% 
...
% % \begin{frame}[plain]
% % \begin{textblock}{128}(0,0)
% % \includegraphics[width=1\textwidth]{../../images/mujerDC}   
% % \end{textblock}
% % \end{frame}
% 
% 
...
% % 
% % \centering
% % \includegraphics[width=0.85\textwidth]{../../figures/elo-factor-en}   
% % 
% % \pause
% % \vspace{0.3cm}
% % 
...
%   \centering
%     \includegraphics[width=1\textwidth]{../../figures/elo-factor-es_0} 
%    %\caption*{$g_3(x_3)$}
%   \end{subfigure} 
% \end{figure}
% \end{textblock}
...
% % \begin{figure}[H]
% %  \centering
% %   \includegraphics[width=1\textwidth]{../../figures/trueskill_factorGraph_versionGeneral} 
% % \end{figure} 
% % }
% % 
% % 
...
% % \begin{figure}[H]
% %  \centering
% %   \includegraphics[width=1\textwidth]{../../figures/trueskill_factorGraph_2equiops} 
% % \end{figure} 
% % }
% % 
% % \end{frame}
...
% %  \includegraphics[width=1\textwidth]{../../figures/evidence} 
% % \end{textblock}
% % 
% % }
% % 
...
\centering
  \includegraphics[width=0.55\textwidth]{../../images/pachacuteckoricancha.jpg}
\end{frame}
