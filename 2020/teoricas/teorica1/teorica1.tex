...
\institute[DC-ICC-CONICET]{\vspace{1.25cm} \includegraphics[width=0.2\textwidth]{../../../aux/static/logofcen}}
\date{}
...
%  \includegraphics[width=0.27\textwidth]{../../../aux/static/logoAntropocaos} 
%  \end{textblock}
%   \begin{textblock}{100}(57,13.5)
%  \includegraphics[width=0.57\textwidth]{../../../aux/static/argonautasDelCaos} 
%  \end{textblock}
% 
 \vspace{2cm}
\maketitle
...
\begin{figure}[H]     
     ...
     \begin{subfigure}[b]{0.75\textwidth}
       \includegraphics[width=1\textwidth]{../../../aux/static/incertidumbre.jpeg} 
     \end{subfigure}
\end{figure}
...
\begin{textblock}{118}(5,24)
  \begin{figure}[H]     
     ...
     \begin{subfigure}[b]{0.9\textwidth}
       \includegraphics[width=1\textwidth]{../../../aux/static/peligro_predador.jpeg} 
     \end{subfigure}
\end{figure}
\end{textblock}
...
\vspace{-1cm}
 ...
 \begin{center}
\includegraphics[width=0.23\textwidth]{../../../aux/static/dosdados.jpg}
 \end{center}
...
%   \includegraphics[width=1\textwidth]{../../../aux/static/laberintoPorArriba.jpg}
%  \end{textblock}
%  
%   
% \end{frame}
...
%        \includegraphics[width=1\textwidth]{../../../aux/static/messi_datos.jpeg} 
%      \end{subfigure}
% \end{figure}
% \end{textblock}
% 
...
% % \begin{frame}[plain]
% % \begin{textblock}{128}(0,0)
% % \includegraphics[width=1\textwidth]{../../../aux/static/mujerDC}   
% % \end{textblock}
% % \end{frame}
% 
% 
